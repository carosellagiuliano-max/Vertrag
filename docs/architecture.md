# Architektur – Schnittwerk Salon OS (Phase 7)

## Zielsetzung
- Phase 7 härtet das Admin-Portal mit Analytics für Buchungen/Umsatz/Retention, Leerzuständen und automatisierten Domain-Tests (Booking, Voucher, Loyalty, Notifications).
...
- `app/` – Routing, Layout und Seiten (App Router). Einstieg `app/page.tsx` zeigt Phase-6-Status, Booking/Portal/Shop/Admin-Links.
...
## Daten- & Sicherheitsgedanken (Phase 1+6)
...
7. **Phase 7**: Admin-Portal Hardening mit Analytics-Kachel, Leerzuständen und Test-Suite für Booking/Voucher/Loyalty/Notifications.
